...
/// Modal mejorado para agregar notas con selección de evaluaciones del sílabo
...
class _AddNotaWithSyllabusModalState extends State<AddNotaWithSyllabusModal> {
  ...
  void initState() {
    ...
    // Obtener evaluaciones disponibles (sin notas registradas)
  ...
  void _agregarNota() {
    ...
    // Agregar la nota con el ID de evaluación
  ...
  Widget build(BuildContext context) {
    ...
    final primaryColor = colors.primaryContainer;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Sección de Evaluación del Sílabo
            Text(
